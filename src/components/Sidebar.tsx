...
function IconCaisse({ c = 'currentColor' }: { c?: string }) {
  return (
    <svg width="17" height="17" viewBox="0 0 20 20" fill="none" aria-hidden="true">
      <rect x="2" y="6.5" width="16" height="11" rx="1.5" stroke={c} strokeWidth="1.4"/>
      <path d="M6 6.5V5a4 4 0 018 0v1.5" stroke={c} strokeWidth="1.4" strokeLinecap="round"/>
      <circle cx="10" cy="12" r="2" stroke={c} strokeWidth="1.3"/>
      <path d="M10 10.5v-.5M10 14v-.5" stroke={c} strokeWidth="1.2" strokeLinecap="round"/>
    </svg>
  )
}

function IconSuppliers({ c = 'currentColor' }: { c?: string }) {
  return (
    <svg width="17" height="17" viewBox="0 0 20 20" fill="none" aria-hidden="true">
      <path d="M3 17V9l7-6 7 6v8" stroke={c} strokeWidth="1.4" strokeLinejoin="round"/>
      <rect x="7.5" y="11" width="5" height="6" rx="1" stroke={c} strokeWidth="1.3"/>
      <path d="M10 11v6" stroke={c} strokeWidth="1.2" strokeLinecap="round"/>
    </svg>
  )
}

function IconReturn({ c = 'currentColor' }: { c?: string }) {
  return (
    <svg width="17" height="17" viewBox="0 0 20 20" fill="none" aria-hidden="true">
      <path d="M4 10.5A6.5 6.5 0 1110.5 4H8" stroke={c} strokeWidth="1.45" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M8 1.5L5 4.5l3 3" stroke={c} strokeWidth="1.45" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M10 12h5M13 9.5l2.5 2.5L13 14.5" stroke={c} strokeWidth="1.35" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  )
}
